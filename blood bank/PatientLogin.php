...
<body>
    ...
    <div class="login-container">
        ...
        <div class="register-link">
            Don't have an account? <a href="PatientRegister.php">Register here</a>
        </div>
    </div>
    <!-- Footer -->
    <footer>
...
if (isset($_GET['email'])) {
   ...
   echo $query = "SELECT * FROM patientregister WHERE Patient_Email = '$a' AND password = '$b'";
    $result = mysqli_query($con, $query);

    if ($row = mysqli_fetch_array($result)) {
        $_SESSION['Patient_Name'] = $row['Patient_Name'];
        echo "<script>window.location='PatientDashboard.php'</script>";
    } else {
