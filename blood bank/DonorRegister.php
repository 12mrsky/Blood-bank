...
<body>
 ...
 <form action="DonorRegisterphp.php">
    <!-- Registration Form -->
    <div class="register-container">
        <h2>Donor Registration</h2>
        <form action="DonorRegisterAction.php" method="get">
            <div class="input-group">
                <label for="donor_id">Donor ID</label>
                <input type="text" id="donor_id" name="Donor_ID" placeholder="Enter Donor ID" required>
            </div>
        ...
        <div class="login-link">
            Already have an account? <a href="DonorLogin.php">Login here</a>
        </div>
    </div>
    <!-- Footer -->
    <footer>
